          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 p-6 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-elevated)] space-y-4">
              ...
              <div className="flex gap-2">
                <input type="text" placeholder="Coupon code" className="input text-sm" id="coupon-input" />
                <button className="btn btn-outline btn-sm whitespace-nowrap" onClick={handleApplyCoupon}>
